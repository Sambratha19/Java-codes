...
public class main_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton2.setText("ELEPHANT");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if(jRadioButton1.isSelected()){
            ...
            JOptionPane.showMessageDialog(rootPane, "Select your favourite pet Animal");
        }
        jTextField1.setText("");
        jTextField2.setText("");
        jRadioButton1.setSelected(false);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if(p1>p2 && p1>p3){
            JOptionPane.showMessageDialog(rootPane, "Dogs "+p1+"\nElephant "+p2+"\nPanda "+p3+"\n\nDogs has a lead");
        }
        else if(p2>p1&&p2>p3){
            JOptionPane.showMessageDialog(rootPane, "Dogs "+p1+"\nElephant "+p2+"\nPanda C "+p3+"\n\nElephant has a lead");
        }
